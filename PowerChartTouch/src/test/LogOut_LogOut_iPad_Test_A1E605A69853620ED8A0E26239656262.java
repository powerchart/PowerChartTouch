...
public class LogOut_LogOut_iPad_Test_A1E605A69853620ED8A0E26239656262 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public LogOut_LogOut_iPad_Test_A1E605A69853620ED8A0E26239656262(IContainer container, String invocationId) {
		super(container, "LogOut_LogOut_iPad", invocationId, "A1E605A69853620ED8A0E26239656262");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(applicationContext_3(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: LogOut_LogOut_iPad_Test_A1E605A69853620ED8A0E26239656262 ",e);
	    } finally {
	        super.execute();
		}	    
    }
