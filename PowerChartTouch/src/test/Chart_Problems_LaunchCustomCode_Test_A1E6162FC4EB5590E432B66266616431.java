...
public class Chart_Problems_LaunchCustomCode_Test_A1E6162FC4EB5590E432B66266616431 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public Chart_Problems_LaunchCustomCode_Test_A1E6162FC4EB5590E432B66266616431(IContainer container, String invocationId) {
		super(container, "Chart_Problems_LaunchCustomCode", invocationId, "A1E6162FC4EB5590E432B66266616431");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(new CustomCode_1(this, dcVars[0]));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: Chart_Problems_LaunchCustomCode_Test_A1E6162FC4EB5590E432B66266616431 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	public MoebStepBatchAction applicationContext_1(IContainer parent) {
		MoebStepBatchAction stepBatch = new MoebStepBatchAction(parent,
												  ...
												  "{\"id\":\"0\",\"declaredClass\":\"com.ibm.rational.test.lt.core.moeb.model.transfer.testscript.DeviceTestSteps\",\"steps\":[{\"uid\":\"A1E5EA2AE8E07BA0F48EB36166393661\",\"application_package\":\"com.devcernerpowerchart.ambulatory\",\"application_os\":\"iOS\",\"isWeb\":false,\"description\":\"Start <b>PowerChart<\\/b>\",\"action\":{\"id\":\"2\",\"declaredClass\":\"com.ibm.rational.test.lt.core.moeb.model.transfer.testscript.DeviceAction\",\"type\":\"start\",\"parameters\":[{\"name\":\"activity\",\"id\":\"3\",\"declaredClass\":\"com.ibm.rational.test.lt.core.moeb.model.transfer.testscript.DeviceParameter\",\"type\":\"TString\"},{\"name\":\"rmot_kind_of_launch\",\"id\":\"4\",\"declaredClass\":\"com.ibm.rational.test.lt.core.moeb.model.transfer.testscript.DeviceParameter\",\"type\":\"TString\",\"value\":\"playback\"}]},\"sync_policy\":\"SYNC-WITH-NEXT-STEP\",\"id\":\"1\",\"to_overriden\":false,\"declaredClass\":\"com.ibm.rational.test.lt.core.moeb.model.transfer.testscript.DeviceHWActionStep\",\"application_uid\":\"835BB2BE68E6A62430C17814008427A5\",\"timeout\":0}],\"timeout\":10}",
												  "/PowerChartTouch/iOS Applications/Chart/Smoke Tests/PCT-VR-Problem-SmokeTest/SmokeTest Functions/Chart_Problems_LaunchCustomCode.testsuite",
	...
	public class CustomCode_1 extends CustomCodeAction {
		...
		public CustomCode_1(IContainer parent, IDataCorrelationVar outVar) {
			super(parent, "Navigate.Class", "A1E5F2B44826B703E3F1E26563303839");
			this.outVar = outVar;
		}
		...
		public void execute() {
			...
			ICustomCode2 ccclass = 	new Navigate.Class();
