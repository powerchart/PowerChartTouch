...
public class EstablishRelationShipWindowiPad_Test_A1E608ABA370FE83EE5AE26131613130 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public EstablishRelationShipWindowiPad_Test_A1E608ABA370FE83EE5AE26131613130(IContainer container, String invocationId) {
		super(container, "EstablishRelationShipWindowiPad", invocationId, "A1E608ABA370FE83EE5AE26131613130");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(ltIf_1(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: EstablishRelationShipWindowiPad_Test_A1E608ABA370FE83EE5AE26131613130 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	VariableAction vc = new VariableAction(parent, "", "A1E5CEEF38A214C7EC07E23461303564");	
			vars[0] = new DataVar("relationShipType", "", IDataArea.VIRTUALUSER, "IGNORE", false, false);
