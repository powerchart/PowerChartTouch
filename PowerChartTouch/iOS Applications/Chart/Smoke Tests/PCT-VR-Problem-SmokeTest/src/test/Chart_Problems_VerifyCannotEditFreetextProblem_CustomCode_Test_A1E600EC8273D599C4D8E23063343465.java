...
public class Chart_Problems_VerifyCannotEditFreetextProblem_CustomCode_Test_A1E600EC8273D599C4D8E23063343465 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public Chart_Problems_VerifyCannotEditFreetextProblem_CustomCode_Test_A1E600EC8273D599C4D8E23063343465(IContainer container, String invocationId) {
		super(container, "Chart_Problems_VerifyCannotEditFreetextProblem_CustomCode", invocationId, "A1E600EC8273D599C4D8E23063343465");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.addEventBehavior(new RPTEventStructure(new RPTCustomCodeExceptionEvent(), new RPTStopUserEvent("Custom Code reported an unhandled exception"), 1, "Custom Code reported an unhandled exception"));
			...
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: Chart_Problems_VerifyCannotEditFreetextProblem_CustomCode_Test_A1E600EC8273D599C4D8E23063343465 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	public class CustomCode_1 extends CustomCodeAction {
		...
		public CustomCode_1(IContainer parent, IDataCorrelationVar outVar) {
			super(parent, "FreeTextEdit.Class", "A1E600ECA8179B20C4D8E23063343465");
			this.outVar = outVar;
		}
		...
		public void execute() {
			...
			ICustomCode2 ccclass = 	new FreeTextEdit.Class();
