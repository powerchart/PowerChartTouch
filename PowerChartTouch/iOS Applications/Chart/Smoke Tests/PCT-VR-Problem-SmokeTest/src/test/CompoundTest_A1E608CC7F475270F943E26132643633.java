...
public class CompoundTest_A1E608CC7F475270F943E26132643633 extends
		com.ibm.rational.test.lt.kernel.action.impl.CompoundTest {

	public CompoundTest_A1E608CC7F475270F943E26132643633(IContainer parent,
			String name) {
		super(parent, "PCT-VR-Problem-SmokeTest(iPhone)",
				"A1E608CC7F475270F943E26132643633");
	}
	...
	public void execute() {
		...
		this.add(new test.PatientSearch_OpenPatientChart_iPhone_Test_A1E5F1CEB4DBD19CDFEEB03663373561(
				this, "A1E608D015D63B40F943E26132643633") {
			public void execute() {
				this.setRtbEnabled(false);
				super.execute();
			}
		...
		this.add(new test.Chart_ChangePatientOrEncounter_iPhone_Test_A1E608D0DEB01400F943E26132643633(
				this, "A1E608D1A42F7720F943E26132643633") {
			public void execute() {
				this.setRtbEnabled(false);
				super.execute();
			}
		...
		this.add(new test.LogOut_LogOut_iPhone_Test_A1E601A3DDF5F68DF886E66533333539(
				this, "A1E608D192D1AA20F943E26132643633") {
			public void execute() {
				this.setRtbEnabled(false);
				super.execute();
			}
		...
		this.add(new test.PatientSearch_OpenPatientChart_iPhone_Test_A1E5F1CEB4DBD19CDFEEB03663373561(
				this, "A1E608D18B1030E2F943E26132643633") {
			public void execute() {
				this.setRtbEnabled(false);
				super.execute();
			}
		...
		this.add(new test.LogOut_LogOut_iPhone_Test_A1E601A3DDF5F68DF886E66533333539(
				this, "A1E608D197A1F6E0F943E26132643633") {
			public void execute() {
				this.setRtbEnabled(false);
				super.execute();
			}
