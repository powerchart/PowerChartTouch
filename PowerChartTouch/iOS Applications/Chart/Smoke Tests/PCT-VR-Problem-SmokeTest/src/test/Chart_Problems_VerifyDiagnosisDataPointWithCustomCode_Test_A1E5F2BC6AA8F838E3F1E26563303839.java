...
public class Chart_Problems_VerifyDiagnosisDataPointWithCustomCode_Test_A1E5F2BC6AA8F838E3F1E26563303839 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public Chart_Problems_VerifyDiagnosisDataPointWithCustomCode_Test_A1E5F2BC6AA8F838E3F1E26563303839(IContainer container, String invocationId) {
		super(container, "Chart_Problems_VerifyDiagnosisDataPointWithCustomCode", invocationId, "A1E5F2BC6AA8F838E3F1E26563303839");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.addEventBehavior(new RPTEventStructure(new RPTCustomCodeExceptionEvent(), new RPTStopUserEvent("Custom Code reported an unhandled exception"), 1, "Custom Code reported an unhandled exception"));
			...
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: Chart_Problems_VerifyDiagnosisDataPointWithCustomCode_Test_A1E5F2BC6AA8F838E3F1E26563303839 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	public class CustomCode_1 extends CustomCodeAction {
		...
		public CustomCode_1(IContainer parent, IDataCorrelationVar outVar) {
			super(parent, "SelectDataPoint.Class", "A1E5F2BC8F3B26A0E3F1E26563303839");
			this.outVar = outVar;
		}
		...
		public void execute() {
			...
			ICustomCode2 ccclass = 	new SelectDataPoint.Class();
