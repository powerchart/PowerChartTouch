...
public class Chart_ProblemsStatus_AddProblemWithCustomCode_Test_A1E5F2B51A27DAA5E3F1E26563303839 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public Chart_ProblemsStatus_AddProblemWithCustomCode_Test_A1E5F2B51A27DAA5E3F1E26563303839(IContainer container, String invocationId) {
		super(container, "Chart_ProblemsStatus_AddProblemWithCustomCode", invocationId, "A1E5F2B51A27DAA5E3F1E26563303839");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(applicationContext_1(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: Chart_ProblemsStatus_AddProblemWithCustomCode_Test_A1E5F2B51A27DAA5E3F1E26563303839 ",e);
	    } finally {
	        super.execute();
		}	    
    }
