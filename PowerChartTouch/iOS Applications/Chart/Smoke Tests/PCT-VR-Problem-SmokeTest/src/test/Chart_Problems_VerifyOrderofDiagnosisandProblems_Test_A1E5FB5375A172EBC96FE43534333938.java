...
public class Chart_Problems_VerifyOrderofDiagnosisandProblems_Test_A1E5FB5375A172EBC96FE43534333938 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public Chart_Problems_VerifyOrderofDiagnosisandProblems_Test_A1E5FB5375A172EBC96FE43534333938(IContainer container, String invocationId) {
		super(container, "Chart_Problems_VerifyOrderofDiagnosisandProblems", invocationId, "A1E5FB5375A172EBC96FE43534333938");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(applicationContext_1(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: Chart_Problems_VerifyOrderofDiagnosisandProblems_Test_A1E5FB5375A172EBC96FE43534333938 ",e);
	    } finally {
	        super.execute();
		}	    
    }
