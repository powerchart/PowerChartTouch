...
public class Chart_Problems_VerifyThisVisitSwitchOnWithDiagAssistant_Test_A1E601B2ACC4BD80F886E66533333539 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public Chart_Problems_VerifyThisVisitSwitchOnWithDiagAssistant_Test_A1E601B2ACC4BD80F886E66533333539(IContainer container, String invocationId) {
		super(container, "Chart_Problems_VerifyThisVisitSwitchOnWithDiagAssistant", invocationId, "A1E601B2ACC4BD80F886E66533333539");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.addEventBehavior(new RPTEventStructure(new RPTCustomCodeExceptionEvent(), new RPTStopUserEvent("Custom Code reported an unhandled exception"), 1, "Custom Code reported an unhandled exception"));
			...
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: Chart_Problems_VerifyThisVisitSwitchOnWithDiagAssistant_Test_A1E601B2ACC4BD80F886E66533333539 ",e);
	    } finally {
	        super.execute();
		}	    
    }
