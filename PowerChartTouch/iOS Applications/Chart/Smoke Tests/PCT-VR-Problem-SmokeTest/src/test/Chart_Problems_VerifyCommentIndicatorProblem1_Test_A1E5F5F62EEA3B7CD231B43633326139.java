...
public class Chart_Problems_VerifyCommentIndicatorProblem1_Test_A1E5F5F62EEA3B7CD231B43633326139 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public Chart_Problems_VerifyCommentIndicatorProblem1_Test_A1E5F5F62EEA3B7CD231B43633326139(IContainer container, String invocationId) {
		super(container, "Chart_Problems_VerifyCommentIndicatorProblem1", invocationId, "A1E5F5F62EEA3B7CD231B43633326139");
		setArmEnabled(true);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(applicationContext_1(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: Chart_Problems_VerifyCommentIndicatorProblem1_Test_A1E5F5F62EEA3B7CD231B43633326139 ",e);
	    } finally {
	        super.execute();
		}	    
    }
